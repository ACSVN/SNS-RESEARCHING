...
img <-imsub(img, x<780, y<680)
img <-imsub(img, x>170, y>130)
...
##-----------------------Page 1
pptxpath <- paste0("C:/SNS-TWITTER/","/output/", "Twitter-PPT.pptx")
...
mypptx <- ph_with_img_at(x = mypptx, src = topcaption, height = 5, width = 4.8,
                         left = 0, top = 1.2, rot = 45 )
##-----------------------Page 3
